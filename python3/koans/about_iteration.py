...
class AboutIteration(Koan):
    ...
    def test_reduce_will_blow_your_mind(self):
        ...
        # Reduce takes a two-argument function and plugs the first two
        # elements of an iterable into its first pass; then takes the result
        # and plugs it in as the first argument and the next iterable as its
        # second argument. This continues until there are no iterables left,
        # returning a single value (thus 'reducing' an iterable into a
        # single value)
